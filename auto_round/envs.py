...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    in ("1", "true", "yes"),
    "AR_MAX_GPU_MEMORY_GB": lambda: os.getenv("AR_MAX_GPU_MEMORY_GB", None),
    "AR_MAX_CPU_MEMORY_GB": lambda: os.getenv("AR_MAX_CPU_MEMORY_GB", None),
    "AR_FORCE_DISK_OFFLOAD": lambda: os.getenv("AR_FORCE_DISK_OFFLOAD", "0").lower() in ("1", "true", "yes"),
}
